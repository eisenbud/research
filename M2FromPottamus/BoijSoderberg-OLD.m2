...
///
restart
load "BoijSoderberg-OLD.m2"
d={0,1,3}
facetEquation(d,0,0,1)
facetEquation(d,0,-1,1)
facetEquation(d,0,0,2)
d={1,2,4,7}
facetEquation(d,0,0,4)
...
--dot product of matrices as vectors
     sum(r+1,i->sum(n+1,j->A_(i,j)*B_(i,j)))
dotProduct(HashTable, HashTable):=(A,B)->
