--This file differs from "NodalCuspidalCurves.m2" in that the computation is done mod a different prime
newPackage(
	"NodalCuspidalCurves2",
   	Version => "0.2", 
   	Date => "July 14, 2010",
...
doc ///
 ...
 Description
   Text
     ...
     @TO installPackage@("NodalCuspidalCurves2")
...
installPackage("NodalCuspidalCurves2",RerunExamples=>true,RemakeAllDocumentation=>true);
viewHelp"NodalCuspidalCurves2"
setRandomSeed("alpha")
