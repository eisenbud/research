...
doc ///
  ...
  Description
    Text
      ...
      @TO installPackage@("NodalCuspidalCurves3")
...
restart
uninstallPackage("NodalCuspidalCurves3")
installPackage("NodalCuspidalCurves3",RerunExamples=>true,RemakeAllDocumentation=>true);
viewHelp"NodalCuspidalCurves3"
setRandomSeed("alpha")
  
time tally apply(10,i->verifyFarkasPrymGreenConjecture(10,2,Printing=>true)) -- used 2.51 seconds
...
time verifyFarkasPrymGreenConjecture(16,2,12,Printing=>true)
