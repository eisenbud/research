...
export{canonicalMultipliers,getRootOfUnity,linearSeriesFromMultipliers,changeMultiplier,
     ...
     verifyFarkasOnRandomNodalCurve, PQ}
...
time verifyFarkasOnRandomNodalCurve(10,Printing=>true) -- used 23.83 seconds
...
time tally apply(10,i->(
	   (L,I)=randomPrymCanonicalNodalCurve(7,2,4);
	  time betti res(I,LengthLimit=>2)
	  ))
