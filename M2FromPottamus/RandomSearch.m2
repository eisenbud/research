...
--%%%This will be a built-in%%%%%%%%%=
appendToFile = (filename, str) -> ("!cat >>"|filename) << str << endl << close
--
...
restart
load "/Users/de/Documents/M2/RandomSearch.m2"
...
load "/Users/de/Documents/M2/RandomSearch.m2"
R = ZZ/31[vars(0..9)]
halfvars=ideal (vars R)_{0..4}
--B0 = ideal(a,b,c,d,e)
--B = flatten entries super basis(2,B0)
B= flatten entries gens ((ideal vars R)^2)
H = () -> trim randomSparseIdeal(B,1,8)

test=I->(
     R:= ring I;
r:=regularity (R^1/I);
L:=for p from 0 to 5 list(
     (regularity Tor_p(R^1/I, R^1/halfvars)));
indicator:=true;
for p from 0 to 5 do (if L_p>r+p then indicator=false);
...
for m from 1 to 100 do test()

One of the counterexamples:
I=ideal (f*j, d*j, a*i, f*g, b*g, a*b)
--i=ideal (e*j, b*j, h , b*h, d*g, b*f, d*e, c*e), 
regularity i
regularity (R^1/I) -- 2
L=for p from 0 to 3 list(
     (regularity Tor_p(R^1/I, R^1/halfvars)))

I=H();

test (I=ideal (f^2, d^2, a*i, b*g, a*b))
test (I=ideal (f^2, d^2, a*i, b*g, a*b))
test I
betti res I
betti res prune Tor_3(R^1/I, R^1/halfvars)
annihilator Tor_3(R^1/I, R^1/halfvars)
R^1/halfvars
...
time Is = for i from 1 to 1000 list (J := trim H(); 
