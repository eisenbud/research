...
doc ///
  ...
  Description
   Text
     ...
     ring. Note that this is computed with respect to a specified maximal ideal,
     namely the ideal of the variables of the ring of $I$.
     When $I$ is an ideal (and more generally, with the right
     definitions) the analytic spread of $I$ is the smallest number of
     generators of an ideal $J$ such that $I$ is integral over $J$. Note
     that these may be inhomogeneous even if $I$ is homogeneous, and this
     integral dependence may be true only in the local ring at the specified
     maximal ideal.  See for
