...
restart
installPackage "./Snowbird/ReesAlgebra"
...
restart
load "bug1ReesAlgebra.m2"
load "./Snowbird/ReesAlgebra.m2" -- complains about "reesIdeal" being in 
--User#"private dictionary"
--although it's not defined above!

S=kk[x,y]
i=ideal"x5,y5, x3y2"

res reesIdeal(i, i_0) -- works

YRR i -- complains that there's no function "reesIdeal"
