...
--this one is harder!
K = toField QQ[z,w]/ideal(z^3-1,w^2-2)
time F = makeExample(R,4,{1,2,1},K,{z,w,z+w}) -- this takes 97 seconds! (has 8-digit coeffs)
pF = puiseux(F, 30)
m = #pF
for i from 0 to m-1 do print (testPuiseux(pF_i,F,30))
...
*{
--this one is too hard: takes almost 7 hours to construct the polynomial F,
-- which has coefficients of order 10^12.
K = toField QQ[z,w]/ideal(z^3-1,w^2-2)
